...
inline void EncodeEntropyRand(ULID& ulid) {
	ulid.data[6] = (uint8_t)(std::rand() * 255ul) / RAND_MAX;
	ulid.data[7] = (uint8_t)(std::rand() * 255ul) / RAND_MAX;
	ulid.data[8] = (uint8_t)(std::rand() * 255ul) / RAND_MAX;
	ulid.data[9] = (uint8_t)(std::rand() * 255ul) / RAND_MAX;
	ulid.data[10] = (uint8_t)(std::rand() * 255ul) / RAND_MAX;
	ulid.data[11] = (uint8_t)(std::rand() * 255ul) / RAND_MAX;
	ulid.data[12] = (uint8_t)(std::rand() * 255ul) / RAND_MAX;
	ulid.data[13] = (uint8_t)(std::rand() * 255ul) / RAND_MAX;
	ulid.data[14] = (uint8_t)(std::rand() * 255ul) / RAND_MAX;
	ulid.data[15] = (uint8_t)(std::rand() * 255ul) / RAND_MAX;
}
